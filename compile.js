...
const filePath = path.resolve(__dirname, 'MyGovernanceToken.sol');
...
if (!tempFile.contracts || !tempFile.contracts['MyGovernanceToken.sol'] || !tempFile.contracts['MyGovernanceToken.sol']['MyGovernanceToken']) {
  throw new Error('Compilation failed or contract not found in the compiled output');
}

// Extract the compiled contract
const contractFile = tempFile.contracts['MyGovernanceToken.sol']['MyGovernanceToken'];
